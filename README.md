...
# 02/20 작업
- 은지
1. 마이페이지 js 시작 : 네비 / 예약내역 / 포인트 작업완료 
2. accommodation_ej : 데이터베이스 정리
- 일혁 
1. 상세페이지 팝업, 반응형 작업중
- 민아
1. pay scss 미완성 부분 완성 및 반응형 작업
2. service_inquiry 반응형 작업
3. 데이터베이스 내용 추가
- 다은
--------------------------
# 02/21 작업
- 은지
1.  event_new_year,event_best_sole 반응형
2. user_info.js :작업중
3. event_new_year -> user_info 쿠폰함으로 이동 js 완료
4. event 반응형 완료
- 일혁 
1. 상세페이지 팝업, 반응형 작업중
- 민아
...
- 다은
1. 필터 기능 제작
2. 로그인, 회원가입 더 손 안 대도 되도록 완성해두기
3. 헤더, 푸터 반응형 : php 나눠둠, 헤더 버전2 만들어서 반응형 작업 예정 / 헤더에 chat 상담창 추가
--------------------------
# 02/22 작업
- 은지
1. 쿠폰 완료 내 정보관리 작업중
