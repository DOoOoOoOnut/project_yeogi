...
// 할인혜택 걸러주는 필터
function getAccommodationsByDiscountBenefits(benefits) { // 
    return data.filter( // data 배열에 있는 object를 하나씩 e 매개변수에 넣어주고 true를 반환하는 값만 추가
...
function filterHandler(){ 
    // 1. 사용자가 무엇을 선택했는지 name으로 확인해 배열로 가져오기
